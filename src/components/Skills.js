...
function Skills() {
  ...
  const[skills,setSkills] = useState([
    ...
    {
      technology : "Backend",
      logo : "https://www.freepik.com/free-vector/application-programming-interface-concept-illustration_25625375.htm#query=backend&position=1&from_view=keyword&track=sph",
      all : [
        {
        name : "NodeJs",
